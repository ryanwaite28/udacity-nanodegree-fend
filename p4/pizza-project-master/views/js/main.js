...
JavaScript > Style > Layput > Paint > Composite
...
//for every instance of accessing the document(DOM), i created a var for it.
var RandomPizza = document.getElementById("randomPizzas");
...
function updatePositions() {
  ...
  var bodyScroll = document.body.scrollTop / 1250;
  for (var i = 0; i < itemsLength; i++) {
	var phase = Math.sin(bodyScroll + (i % 10));  
